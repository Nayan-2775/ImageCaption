...
def main():
    ...
    if uploaded_image is not None:
        ...
        model_path = "model/model.keras"  # Replace with the actual path
        tokenizer_path = "model/tokenizer.pkl"  # Replace with the actual path
        feature_extractor_path = "model/feature_extractor.keras"  # Replace with the actual path
